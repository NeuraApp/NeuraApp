...
const FloatingShapes = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-20 left-10 w-20 h-20 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-full animate-float-slow" />
      <div className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rotate-45 animate-float-medium" />
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-gradient-to-r from-pink-500/20 to-purple-500/20 rounded-full animate-float-fast" />
      <div className="absolute bottom-20 right-40 w-24 h-24 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rotate-12 animate-float-slow" />
      ...
      <div className="absolute bottom-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-cyan-500/50 to-transparent animate-pulse delay-1000" />
    </div>
  );
};
...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#0A0A0A] text-white antialiased overflow-x-hidden">
      ...
      {/* Header */}
      <header className="sticky top-0 bg-black/20 backdrop-blur-xl z-40 border-b border-white/5">
      ...
      <main>
        ...
        <section className="relative min-h-screen flex items-center justify-center">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-blue-900/10 to-black opacity-80" />
      ...
      {/* Footer */}
      <footer className="bg-black/40 backdrop-blur-xl border-t border-white/5 py-16 px-6">
